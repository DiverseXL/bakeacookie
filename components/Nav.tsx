...
export default function Nav() {
  return (
    <div className="sticky top-0 z-50 w-full px-4 pt-4">
      <header
        id="nav-capsule"
        className="mx-auto flex w-full max-w-5xl items-center justify-between gap-3 rounded-pill border-[3px] border-navy py-2 pl-5 pr-2"
        style={{
      ...
      >
        ...
        <nav className="flex items-center gap-2" aria-label="Primary">
          <a
            ...
            className="inline-flex items-center gap-1.5 rounded-pill border-2 border-navy bg-cream px-3.5 py-2 text-sm font-bold text-navy no-underline transition-all duration-150 shadow-[0_3px_0_0_rgba(11,31,58,0.6)] hover:translate-y-[2px] hover:shadow-[0_1px_0_0_rgba(11,31,58,0.6)]"
          >
            <DocsIcon />
