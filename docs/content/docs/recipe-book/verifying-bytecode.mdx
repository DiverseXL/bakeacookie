...
The [bakeacookie dashboard](https://bakeacookie.vercel.app) performs the same verification for the "live status strip" on program pages. It uses the exact same logic as the CLI — ported, not reimplemented.
